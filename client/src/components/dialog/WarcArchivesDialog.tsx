...
const WarcArchivesDialog = ({
  ...
  return (
    <Grid container justifyContent="space-between" spacing={2} className={classes.dialog}>
            ...
            <Table>
              <TableHead>
                <TableRow>
                  ...
                  <TableCell>{t<string>('query.buttons.download')}</TableCell>
                </TableRow>
              </TableHead>
              <TableBody>
      ...
      {(currentState === 'WAITING' || !currentState) && (
        <Grid item xs={12}>
            ...
            <Grid item>
              <Button
                ...
                <>
                  ...
                  {t<string>('administration.queries.warc.dialog.requestGeneration')}
                </>
              </Button>
            </Grid>
          </Grid>
...
export default WarcArchivesDialog;
